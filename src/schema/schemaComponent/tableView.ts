...
export default defineComponent({
  props: ['resizable', 'onCellMenu', 'showHeaderFilter', 'onCellClick', 'onCellDblclick', 'showSeqColumn', 'hiddenBorder', 'showHeader', 'height', 'showCheckBoxColumn', 'align', 'animat', 'columns', 'columnConfig', 'data'] as Array<keyof VxeGridProps>,
  setup(props, context) {
