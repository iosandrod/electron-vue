...
export const initRenderTable = (input: input) => {
    ...
    //@ts-ignore
    _this.pageRef.tableRef = _table
}

export const tableInitComponent = (input: input) => {
    const _this = input
            ...
            suffix: () => {
                ...
                return getIcon({
                    ...
                    onClick: (event: MouseEvent) => {
                        ...
                        system.addGlobalDialog('instanceView', { instance: _this.pageRef.tableRef, height: 600, width: 1200, modelValue: true })
                    },
