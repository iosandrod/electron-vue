<template>
  <transition name="bu-loading-fade">
    <div class="bu-loading-mask" v-show="visible" :class="[customClass, fullscreen ? 'is-fullscreen' : '']"
      ...
      <div class="bu-loading-spinner">
        ...
        <div v-for="item in arr" class="bu-loading-text">
          {{ item }}
        </div>
      </div>
    </div>
...
const arr = Array(11111).fill(null).map((row, i) => i)
</script>
